...
var TabsControl = function (_React$PureComponent) {
    ...
    function TabsControl(props) {
        ...
        var _this = _possibleConstructorReturn(this, (TabsControl.__proto__ || Object.getPrototypeOf(TabsControl)).call(this, props));

        _this.monaco = _react2.default.createRef();
        _this.state = {
            currentTabId: -1,
            tabs: props.tabs
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    tabs.map(function (ele) {
                        ...
                        return _react2.default.createElement(
                            'li',
                            { id: id, className: _this3.check_tittle_index(ele.id), key: ele.id, title: tab_title },
                            _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(
                                    'span',
                                    { className: _this3.makeIcoClass(ele.name), onClick: function onClick() {
                                            _this3.tabClick(ele);
                                        } },
                                    ele.name
                                ),
                ...
                _react2.default.createElement(
                    ...
                    tabs.map(function (ele) {
                        ...
                        return _react2.default.createElement(
                            'div',
                            { id: id, key: ele.id, className: _this3.check_item_index(ele.id) },
                            _react2.default.createElement(_MonacoEditor2.default, {
                                ref: _this3.monaco,
                                language: _this3.setLanguage(ele.name),
                                theme: _this3.props.theme ? _this3.props.theme : "vs-dark",
                                value: ele.value,
                                className: ele.name
                            })
                        );
